...
from models_def import Discriminator, Generator
...
class CTGANSynthesizer(object):
    ...
    def evaluate_model(self, epoch, weekday_percentage):
        ...
        gen_weekday_percentage = gen_samples['weekday'].value_counts(normalize=True)

        # sort series by the weekday name
        weekday_percentage = weekday_percentage.sort_index(ascending=True)
        gen_weekday_percentage = gen_weekday_percentage.sort_index(ascending=True)
